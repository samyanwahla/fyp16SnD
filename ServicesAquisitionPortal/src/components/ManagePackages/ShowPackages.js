...
import UserAppBar from '../Layouts/appBar.js';
...
import clientSideBG1 from '../img/clientSideBG1.jpg';
	...
	return (
		<React.Fragment>
			<Container>
				...
				<img src={clientSideBG1} alt="clientSideBG1" className={classes.img} />
			</Container>
			{/* End hero unit */}
						...
						<Grid item key={tier.title} xs={12} sm={tier.title === 'Enterprise' ? 12 : 6} md={4}>
							<Card>
								<CardHeader
									...
									style={{ backgroundColor: tier.backgroundcolor, color: 'white' }}
								/>
								<CardContent>
